...
def train(hyp, opt, device, tb_writer=None):
    ...
    epochs, batch_size, total_batch_size, weights, rank ,labelsPath = \
        opt.epochs, opt.batch_size, opt.total_batch_size, opt.weights, opt.global_rank, opt.labelsPath
    ...
    # Trainloader
    dataloader, dataset = create_dataloader(train_path,labelsPath,imgsz, batch_size, gs, opt, hyp=hyp, augment=True,
    ...
    if rank in [-1, 0]:
        ...
        testloader = create_dataloader(test_path,labelsPath, imgsz_test, batch_size, gs, opt, hyp=hyp, augment=False,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--labelsPath',type=str, default='data/organ_identification/labels/', help='Path to labels files (image_name.txt)')
    parser.add_argument('--weights', type=str, default='yolov4-p5.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/coco128.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='', help='hyperparameters path, i.e. data/hyp_pr.scratch.yaml')
